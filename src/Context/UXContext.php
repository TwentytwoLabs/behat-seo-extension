...
class UXContext extends BaseContext
{
    ...
    public function theSiteShouldNotBeResponsive(): void
    {
        ...
        Assert::notEq(self::EXPECTED_VIEWPORT, $viewportContent, 'Site supports responsive design');
    }

    private function getViewportElement(): NodeElement
    {
        $viewportElement = $this->getSession()->getPage()->find('xpath', '//head/meta[@name="viewport"]');
