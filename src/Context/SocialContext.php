...
final class SocialContext extends BaseContext
{
    ...
    private function validateFullTwitterOpenGraphData(): void
    {
        ...
        Assert::notEmpty(filter_var($this->getOGMetaContent('twitter:image'), FILTER_VALIDATE_URL));
    ...
    private function getOGMetaContent(string $property): string
    {
        ...
        Assert::notNull($ogMeta, sprintf('Open Graph meta %s does not exist', $property));
        Assert::notEmpty(
    ...
    {
        Assert::notEmpty(filter_var($this->getOGMetaContent('og:url'), FILTER_VALIDATE_URL));
        ...
        Assert::notEmpty(filter_var($this->getOGMetaContent('og:image'), FILTER_VALIDATE_URL));
